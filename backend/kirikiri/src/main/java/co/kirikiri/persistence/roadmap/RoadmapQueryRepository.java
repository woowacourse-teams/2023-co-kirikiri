...
public interface RoadmapQueryRepository {
    ...
    List<Roadmap> findRoadmapsByCond(final RoadmapCategory category,
                                     final RoadmapFilterType orderType,
                                     final Long lastValue,
                                     final int pageSize);

    List<Roadmap> searchRoadmaps(final RoadmapFilterType orderType,
                                 final RoadmapSearchDto searchRequest,
                                 final Long lastValue,
                                 final int pageSize);
}
