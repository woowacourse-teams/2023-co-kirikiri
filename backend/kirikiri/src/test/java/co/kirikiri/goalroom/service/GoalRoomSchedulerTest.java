...
import static co.kirikiri.goalroom.domain.GoalRoomStatus.RECRUITING;
...
class GoalRoomSchedulerTest {
    ...
    private GoalRoomPendingMember 골룸_대기자를_생성한다(final GoalRoom goalRoom, final Member follower,
        ...
        return new GoalRoomPendingMember(1L, role, LocalDateTime.of(2023, 7, 19, 12, 0, 0), goalRoom, follower.getId());
    }
}
