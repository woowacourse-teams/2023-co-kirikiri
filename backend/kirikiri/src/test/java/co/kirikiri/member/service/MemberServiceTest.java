...
class MemberServiceTest {
    ...
    void oauth_회원가입을_한다() {
        //given
        final OauthMemberJoinDto oauthMemberJoinDto = new OauthMemberJoinDto("oauthId", "kirikiri@email.com",
                "nickname", GenderType.UNDEFINED);
        ...
        final Member member = new Member(new Identifier("kirikiri"), oauthMemberJoinDto.oauthId(),
                new Nickname(oauthMemberJoinDto.nickname()), null, memberProfile);
        ...
        //when
        final Member result = memberService.oauthJoin(oauthMemberJoinDto);
    ...
    void oauth_회원가입_시_이메일의_아이디와_UUID_길이의_합이_40이하일때_회원을_생성한다(final String value) {
        //given
        final OauthMemberJoinDto oauthMemberJoinDto = new OauthMemberJoinDto("oauthId", value + "@email.com", "nickname",
