...
class AuthControllerTest extends RestDocsHelper {
    ...
    @Test
    void 아이디에_빈값이_들어온_경우_예외를_던진다() throws Exception {
        //given
    ...
    @Test
    void 비밀번호_빈값이_들어온_경우_예외를_던진다() throws Exception {
        //given
    ...
    @Test
    void 아이디와_비밀번호_모두_빈값이_들어온_경우_예외를_던진다() throws Exception {
        //given
    ...
    @Test
    void 아이디에_해당하는_회원이_없을때_예외를_던진다() throws Exception {
        //given
        final LoginRequest request = new LoginRequest("identifier1", "password1!");
        final String jsonRequest = objectMapper.writeValueAsString(request);
    ...
    @Test
    void 비밀번호가_맞지_않을때_예외를_던진다() throws Exception {
        //given
        final LoginRequest request = new LoginRequest("identifier1", "password1!");
        final String jsonRequest = objectMapper.writeValueAsString(request);
