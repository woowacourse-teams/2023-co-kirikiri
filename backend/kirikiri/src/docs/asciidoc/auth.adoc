...
operation::auth-controller-test/정상적으로_로그인에_성공한다[snippets='http-request,http-response,request-fields,response-fields']
...
operation::auth-controller-test/토큰을_정상적으로_재발행한다[snippets='http-request,http-response,request-fields,response-fields']
