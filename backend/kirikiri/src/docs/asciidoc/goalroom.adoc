...
=== *6-2* 실패 - 골룸 멤버 조회 시 존재하지 않는 골룸일 경우
...
=== *7-2* 실패 - 골룸 투두 추가시 존재하지 않는 회원일 경우
...
=== *7-3* 실패 - 골룸 투두 추가시 존재하지 않는 골룸일 경우
...
=== *7-4* 실패 - 골룸 투두 추가시 이미 종료된 골룸일 경우
...
=== *7-6* 실패 - 골룸 투두 추가시 컨텐츠가 250글자가 넘을 경우
